...
public class ResearchCategories {
	...
	//Research
	public static LinkedHashMap <String, com.onenationundercanadia.thaumcraft.api.research.ResearchCategoryList> researchCategories = new LinkedHashMap <String,ResearchCategoryList>();
